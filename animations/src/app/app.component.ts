...
@Component({
  ...
  animations: [
    ...
    trigger('list1', [
      ...
      transition('* => void', [
        animate(300, style({ transform: 'translateX(100px)', opacity: 1 }))
      ])
    ]),
    trigger('list2', [
      state('in', style({
      ...
      transition('void => *', [
        animate(1000, keyframes([
          ...
          style({ transform: 'translateX(0)', opacity: 1, offset: 0.8}),
      ...
      transition('* => void', [
        group([
          ...
          animate(800, style({ transform: 'translateX(100px)', opacity: 1 }))
        ])
      ])
    ]),
  ]
